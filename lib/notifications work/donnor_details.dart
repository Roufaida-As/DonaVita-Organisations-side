...
class _DonnordetailsState extends State<Donnordetails> {
  ...
  void initState() {
    ...
    announcementService =
        AnnouncementService(widget.donnation.orgId, widget.donnation.annonceId);
    fetchData();
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: ClipRRect(
                          // Add ClipRRect for better control
                          borderRadius: BorderRadius.circular(
                              147), // Match container size
                      ...
                      Information(
                        indicator: 'Full name',
                        insideinfo: widget.donnation.fullname,
                        suffixexist: false,
                        category: category,
                      ),
                      const SizedBox(
                      ...
                      Information(
                          ...
                          insideinfo: widget.donnation.phonenumber,
                          suffixexist: false,
                          category: category),
                      const SizedBox(
                        height: 20,
                      ...
                      Information(
                          indicator: 'Adress',
                          insideinfo: widget.donnation.adress,
                          suffixexist: false,
                          category: category),
                      const SizedBox(
                        height: 20,
                      ...
                      Padding(
                        ...
                        child: Information(
                            indicator: 'Quantity donated:',
                            insideinfo: widget.donnation.quantitydonated,
                            suffixexist: true,
                            category: category),
                      ),
                      const SizedBox(
                            ...
                            child: GestureDetector(
                                onTap: () {
                                  final snackBar1 = SnackBar(
                                    ...
                                    content: const Text(
                                      "Progress bar has been updated succefully",
                                      style: TextStyle(
                                          color: Colors.white,
                                          fontWeight: FontWeight.w600),
                                    ),
                                    backgroundColor: AppColors
                                        .clear, // Specify the color here
                                  );
                                  final snackBar2 = SnackBar(
                                    ...
                                    content: const Text(
                                        "Error updating the progress bar",
                                        style: TextStyle(
                                            color: Colors.white,
                                            fontWeight: FontWeight.w600)),
                                    backgroundColor: Colors
                                        .red[400], // Specify the color here
                                  );
                                  ...
                                  FirebaseFirestore.instance
                                      ...
                                      .update({
                                    "quantityDonated":
                                        (int.parse(quantitydonated) +
                                                int.parse(widget
                                                    .donnation.quantitydonated))
                                            .toString()
                                  }).then(
                                          (value) =>
